...
def predict():
    if request.method == "POST":
        ...
        return render_template('result.html', gender="Sex - {}".format(sex), medical="Smoker - {}".format(smoker), area="Region - {}".format(region), years="Age - {}".format(age), body_mass="BMI - {}".format(bmi), kids="Children - {}".format(children), medical_expense=output)
